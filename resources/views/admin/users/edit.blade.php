            ...
            <div class="container-fluid">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title float-left ">Update User</h3>
                    </div>
                    <div class="card-body">
                        <form id="submit_form" method="POST" action="{{ url('admin/users/'. $data->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="firstname" value="{{ old('firstname', $firstname) }}" id="firstname"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lastname" id="lastname" value="{{ old('lastname', $lastname) }}"
                                        ...
                                        <select name="country" class="form-select" id="country">
                                            ...
                                            @foreach ($countries as $country)
                                                <option value="{{ $country->id }}"
                                                    {{ old('country', $data->country_id) == $country->id ? 'selected' : '' }}>
                                                    {{ $country->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" value="{{ old('postal_code',$data->postal_code) }}"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Address</label>
                                        <textarea name="address" id="address" class="form-control" cols="30" rows="2">{{ old('address',$data->address) }}</textarea>
                                    </div>
                                </div>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var oldCountry = "{{ old('country', $data->country_id) }}";
            var oldState = "{{ old('state', $data->state_id) }}";
