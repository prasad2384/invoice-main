    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container">
                ...
                <form action="{{ url('admin/invoices') }}" method="POST" id="invoiceform">
                    @csrf
                    @method('POST')
...
@section('scripts')
    ...
    <script>
        ...
        //         if (gstType === 'IGST') {
        //             // Add headers for GST Rate and IGST Amount
        ...
        //             // Add GST Rate and IGST Amount columns to each row
        ...
        //             // Add headers for GST Rate and CGST & SGST Amounts
        //             $('#invoiceTable thead tr').append(
        ...
        //             // Add GST Rate and CGST & SGST Amount columns to each row
        //             $('#invoiceTable tbody tr').each(function() {
        //                 $(this).append(
        ...
        //             // Ensure that columns related to GST are removed
        //             $('#invoiceTable thead tr .gst-rate-header, #invoiceTable thead tr .igst-amount-header, #invoiceTable thead tr .cgst-header, #invoiceTable thead tr .sgst-header')
        //                 .remove();
        //             $('#invoiceTable tbody tr .gst-rate, #invoiceTable tbody tr .igst-amount, #invoiceTable tbody tr .cgst-amount, #invoiceTable tbody tr .sgst-amount')
        //                 .remove();

        //             // Add Total column header only
        //             $('#invoiceTable thead tr').append(
        ...
        //             $('#invoiceTable tbody tr').each(function() {
        //                 $(this).append(
        //                     '<td class="total-amount"><input type="text" name="total-amount" class="form-control" /></td>'
        //                 );
        //             });

        //             calculateGST(0, 'None'); // Call calculateGST with zero rate for 'None'
        //         }
        ...
        //                 amountCell.val(baseAmount); // Display base amount without fixed precision
        ...
        $(document).ready(function() {
            ...
            $('#gstSelect').change(function() {
                ...
                if (gstType === 'IGST') {
                    ...
                    // No need to append any total or GST columns when "None" is selected
                    calculateGST(0, 'None'); // Call calculateGST with zero rate for 'None'
                }
        ...
        // Trigger calculation on quantity, rate, or tax change
    </script>
@endsection
