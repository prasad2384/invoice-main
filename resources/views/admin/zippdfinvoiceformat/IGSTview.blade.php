                    ...
                    <table class="invoice-table" id="invoiceTable">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h5 class="table-info text-right" id="amount">{{ $gst_rate }}%</h5>
                                </td>
                                <td>
                                    <h5 class="table-info text-right" id="amount">{{ $gst_amount }}</h5>
                                </td>
                                <td>
                                    <h5 class="table-info text-right" id="amount">{{ $total_amount }}</h5>
                                </td>
                            </tr>
                        </tbody>
                    </table>
