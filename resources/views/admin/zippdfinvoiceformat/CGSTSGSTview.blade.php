                    ...
                    <table class="invoice-table" id="invoiceTable">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h5 class="table-info text-right" id="amount">{{ $amount }}</h5>
                                </td>
                                <td>
                                    <h5 class="table-info text-right">{{ $gst_rate }}%</h5>
                                </td>
                                <td>
                                    <h5 class="table-info text-right">{{ $cgst_amount }}</h5>
                                </td>
                                <td>
                                    <h5 class="table-info text-right">{{ $sgst_amount }}</h5>
                                </td>
                                <td>
                                    <h5 class="table-info text-right">{{ $total_amount }}</h5>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="additional-info-table">
                        <table class="invoice-table">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <h4 class="text-right total-amount" id="total_amount">{{ $total_amount }}
                                    </h4>
                                </td>
                            </tr>
                        </table>
